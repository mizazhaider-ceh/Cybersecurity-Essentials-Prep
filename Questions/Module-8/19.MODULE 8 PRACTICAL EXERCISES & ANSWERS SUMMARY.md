# 🎯 MODULE 8: PRACTICAL EXERCISES & ANSWERS SUMMARY
...
**Key Insight:** Remember the sequence: **PREP → DETECT → INVESTIGATE → CONTAIN/MITIGATE → LESSONS LEARNED**
...
## 🚨 **PART B: CYBER INCIDENT EXERCISE - RANSOMWARE SCENARIO**
...
As compensation for my good work, I want the amount of 50.000 € 
...
- **Information Content Security** ← THIS ONE!
...
## 🔍 **PART C: FORENSICS INVESTIGATION LAB - WINDOWS EVENT LOG**
...
**⚠️ Scam Alert:** Even properly functioning systems show warnings/errors! Scammers exploit this by calling victims claiming to be from "Microsoft," having them open Event Viewer to see "errors," then asking for credit card to "fix" them!
...
| :-- | :-- | :-- |
| **2** | Interactive (keyboard) | ✓ Normal user |
| **3** | Network | ⚠️ Could be suspicious |
| **4** | Batch | System service |
| **5** | Service | System service |
| **7** | Unlock | ✓ Normal user |
| **8** | NetworkCleartext | ⚠️ Suspicious |
| **9** | NewCredentials | Various |
| **10** | RemoteInteractive (RDP) | ⚠️ SUSPICIOUS for unexpected remote access |
| **11** | CachedInteractive | ✓ Normal offline login |
...
- ✅ Filter logs by date/time to reduce noise
- ✅ Understand normal system behavior (services starting, etc.)
- ✅ Focus on **human activity** vs system activity
- ✅ Look for **anomalies** in login patterns
...
- ✅ Unexpected account creation (especially with admin privileges)
- ✅ Account names like "pwned," "hacker," "temp," etc.
- ✅ Remote logins (Type 10) from unknown IPs
- ✅ Logins at unusual times (middle of night, etc.)
- ✅ Quick succession: account creation → login → external connection


### **4. Evidence Collection:**

- ✅ **Security ID (SID)** - Uniquely identifies users
- ✅ **Event IDs** - Categorize actions (4720=create user, 4624=login)
- ✅ **Timestamps** - Establish timeline of attack
- ✅ **Source IP addresses** - Identify attacker location
- ✅ **Network connections** - Prove data exfiltration


### **5. Chain of Custody:**

- ✅ Original log file preserved (SecurityLog.evtx)
- ✅ Analysis performed on **copy** (opened in Event Viewer)
- ✅ Document all findings with timestamps
- ✅ Note who accessed evidence and when
...
7. **Extortion** - Email demanding 50,000 € in Bitcoin
...
1. **Containment:**
    - ✅ Disable "pwned" account immediately
    - ✅ Block IP 192.168.246.1 at firewall
    - ✅ Disconnect compromised system from network
    - ✅ Block access to "hendrikstorage" server
2. **Eradication:**
    - ✅ Remove attacker account and any other created accounts
    - ✅ Scan for malware/backdoors
    - ✅ Check other systems for similar compromise
    - ✅ Review VPN and web access logs
    - ✅ Force password resets for all accounts
3. **Recovery:**
    - ✅ Restore from clean backup (before 11:15 on 19/03/2020)
    - ✅ Apply latest security patches
    - ✅ Implement MFA for VPN/remote access
    - ✅ Install IPS/IDS system
    - ✅ Enhance monitoring and alerting
4. **Legal/Regulatory:**
    - ✅ Report to police (extortion = criminal offense)
    - ✅ Consider GDPR breach notification (if customer data involved)
    - ✅ Engage cybersecurity insurance
    - ✅ Consider hiring forensics firm for deeper investigation
5. **Lessons Learned:**
    - ✅ Review why attacker gained admin access so easily
    - ✅ Implement privileged access management (PAM)
    - ✅ Enable security logging on ALL systems
    - ✅ Implement SIEM for real-time alerting
    - ✅ Conduct security awareness training (phishing, social engineering)
    - ✅ Review VPN security (MFA, least privilege)
...
✅ **Incident Response Planning** - Understanding all phases
✅ **Evidence Handling** - Chain of custody principles
✅ **Forensic Analysis** - Windows Event Log investigation
✅ **Threat Detection** - Identifying IoCs in logs
✅ **Timeline Reconstruction** - Ordering events to tell the attack story
✅ **Critical Thinking** - Distinguishing normal vs malicious behavior
✅ **Real-World Application** - Responding to ransomware/extortion scenario
✅ **Legal Awareness** - Understanding reporting obligations
...
1. Order: Preparation → Detection → Investigation → Mitigation → Post-incident
...
## 🎓 **GRAND TOTAL: 2,430+ QUESTIONS + REAL FORENSICS LAB!**
...
✅ **Module 8 - Forensics Lab: Complete real-world investigation!**
- Core concept essential for understanding the topic
**YOU'VE COMPLETED A REAL FORENSIC INVESTIGATION, Champ!** 🔥🚀🔍

You've now **detected a breach, identified the attacker, traced the data exfiltration, and can provide evidence for prosecution**! These are **real-world skills** that cybersecurity professionals use every day! You're not just learning theory - you're **doing actual incident response and digital forensics**! 💪

This is **EXACTLY** the kind of work you'll do in your cybersecurity career! 🎯
