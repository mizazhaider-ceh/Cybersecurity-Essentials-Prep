# 🎯 MODULE 7: PRACTICAL EXERCISES & ANSWERS SUMMARY
...
## 🔓 **EXERCISE 2: EXAMINING FILES \& PASSWORD CRACKING**
...
## 🦠 **EXERCISE 3: MALWARE IDENTIFICATION (EICAR)**
...
**⚠️ IMPORTANT:** DELETE FILE FROM COMPUTER AND VM AFTER EXERCISE!
...
## 🔐 **EXERCISE 5: BITLOCKER ENCRYPTION**
...
## 🔐 **EXERCISE 6: ADVANCED REGISTRY ACCESS (SAM KEYS)**
...
## 🎯 **KEY PRACTICAL SKILLS LEARNED**

### **Registry Forensics:**

- ✅ UserAssist shows recently executed programs
- ✅ ROT13 "encryption" (easily reversible)
- ✅ RecentDocs shows recently accessed files
- ✅ Extensions organized in subkeys
- ✅ SAM contains sensitive account data


### **Password Security:**

- ✅ Brute force vs dictionary attacks
- ✅ Short passwords crack in seconds
- ✅ 14+ characters recommended
- ✅ Use HaveIbeenpwned to check compromised passwords
- ✅ Mix all character types


### **File Security:**

- ✅ Encrypted files can hide malware
- ✅ EICAR test file for antivirus testing
- ✅ File extensions can be hidden/changed
- ✅ Always examine files in isolated VM


### **Encryption Practices:**

- ✅ BitLocker for full disk encryption
- ✅ Recovery keys critical for access
- ✅ Encryption protects data at rest
- ✅ USB drives can be encrypted


### **System Access:**

- ✅ Administrator ≠ highest privileges
- ✅ NT AUTHORITY\SYSTEM = god mode
- ✅ PsExec elevates privileges
- ✅ Some registry keys hidden even from admin
...
| **BitLocker** | Disk encryption | Drive Tools → BitLocker  |
...
## 🚀 **GRAND TOTAL: 2,230+ QUESTIONS + PRACTICAL LABS!**
...
✅ **Module 7 - Practical Labs: 6 comprehensive exercises**
- Core concept essential for understanding the topic
**YOU'VE MASTERED BOTH THEORY AND PRACTICE, Champ!** 🔥🚀💻

These hands-on exercises give you **real-world cybersecurity skills** that complement your theoretical knowledge perfectly! You're not just learning concepts - you're **doing actual penetration testing, forensics, and security analysis**! 💪
